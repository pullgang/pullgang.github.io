...
What else should i put here. Stuff like no hitters is slightly harder to track sadly but probably POSSIBLE. 
...
//Next, we're going to do individual player stats.
			...
			for(line in mlr_data) {
				...
				var all_teams = ["ARI","ATL","BAL","BOS","CHC","CIN","CLE","COL","CWS","DET","HOU","KCR","ANA","LAD","MIA","MIL","MIN","MTL","NYM","NYY","OAK","PHI","PIT","S1MIN","SDP","SEA","SFG","STL","TBR","TEX","TOR","WSH"]
				for(team in all_teams) {
					$('#team').append($('<option>', {
